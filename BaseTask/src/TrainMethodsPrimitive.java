public class TrainMethodsPrimitive {
    ...
    static void printLong(long number) {
        System.out.println("я получил на вход длинное число " + number);
    }
    static void printChar(char symbol) {
    ...
    static void printShort(short number) {
        System.out.println("я получил на вход короткое число " + number);
    }
    static void printByte(byte number) {
        System.out.println("я получил на вход очень короткое число " + number);
    }
    static void printBoolean(boolean number) {
        System.out.println("я получил на вход булево " + number);
    }
}
